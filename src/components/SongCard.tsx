...
import { Play, Disc, Radio, Heart } from 'lucide-react';
...
export default function SongCard({
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-square w-full overflow-hidden rounded-xl bg-stone-900 border border-[#261E17]/50 shadow-lg group-hover:shadow-brand/5 transition-all duration-300">
        <img
          src={coverUrl}
          alt={title}
      ...
      {/* Meta Text details */}
      <div className="mt-3">
        <h3 className="text-sm font-semibold text-stone-100 group-hover:text-brand transition-colors truncate">
          {title}
        </h3>
